...
public class C02_Xpath {
    ...
    public static void main(String[] args) {
        ...
        SYNTAX:
                ...
                //*[@*='attribüteDeğeri'] --> Eğer bu kullanımda birden fazla sonuç verirse * koyduğumuz yerlere
...
//xpath alırken direk tag'ları kullanarakta unique sonuç vermezse yukarıdaki örnekteki gibi index ile
// elementi handle edebiliriz
        //sayfayi kapatınız
        driver.close();
    }
