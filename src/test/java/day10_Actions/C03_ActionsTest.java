...
public class C03_ActionsTest extends TestBase {
    ...
    //Techproeducation sayfasına gidelim
        ...
        //Sayfayı istedigimiz bir miktar aşagıda dogru scroll yapalım
        ...
        actions.sendKeys(Keys.PAGE_DOWN,Keys.PAGE_DOWN,Keys.PAGE_DOWN,Keys.PAGE_DOWN).perform();
          bekle(2);
        //Sayfayı istediğimiz bir miktar yukarıya  dogru scroll yapalım
    ...
    public void actions3() {
     ...
     // Events yazısına kadar scroll yapalım
        ...
        new Actions(driver).scrollToElement(eventsYazisi).perform();
        bekle(2);
    }
}
