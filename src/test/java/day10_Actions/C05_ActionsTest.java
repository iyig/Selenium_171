...
public class C05_ActionsTest extends TestBase {
    ...
    public void test01() {
        ...
        actions.keyDown(aramaKutusu, Keys.SHIFT). // Arama kutusunda shift tuşuna basılı turar
                sendKeys("selenium"). //Shift tuşuna basılı tutarak SELENİUM yazdıracak
    ...
    public void test03() {
        ...
        WebElement searchBox2= driver.findElement(By.xpath("//*[@id='APjFqb']"));
        Actions actions=new Actions(driver);
        actions.keyDown(searchBox2,Keys.CONTROL).sendKeys("a","x").perform();
        ...
        bekle(2);
        actions.keyDown(aramaKutusu,Keys.CONTROL).sendKeys("v",Keys.ENTER).perform();
    }
}