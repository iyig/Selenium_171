...
bekle(2);
    ...
    public void test01() {
        ...
        WebElement drop = driver.findElement(By.xpath("//*[@id='droppable']"));
        Actions actions = new Actions(driver);
        actions.clickAndHold(drag).moveToElement(drop).release().perform();//Drag webelementini tut ve bekle
        //Drag weblementini tutup drop weblementinin üzerine götürür
        //Basılı tuttugunuz webelemnti serbest bırakır
    }
